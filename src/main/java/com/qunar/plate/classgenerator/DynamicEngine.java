...
public class DynamicEngine {
     ...
     */
    public Object javaCodeToObject(String fullClassName, String javaCode) throws IllegalAccessException, InstantiationException, JavaSrcCodeCompileErrorException {
        ...
        if (success) {
            ...
            throw new JavaSrcCodeCompileErrorException(error);
        }
        return instance;
    }
